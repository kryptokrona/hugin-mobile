        ...
        <Card>
          ...
          <View style={{ flexDirection: 'row' }}>
            <Button
              ...
              type="clear"
            >
              <TextField centered>{t('sendMaxButton')}</TextField>
            </Button>
            <Button
              primary
              onPress={() => {
            ...
            >
              <TextField centered style={{ textTransform: 'uppercase' }} >
                {t('continue')}
              </TextField>
            </Button>
          </View>
  ...
  render() {
    ...
    return (
      <ScreenLayout>
        ...
        <Card>
          <Image
            style={{ width: 50, height: 50, alignSelf: 'center', marginVertical: 12 }}
          ...
          <View style={{ flexDirection: 'row' }}>
            <Button
              style={{ marginRight: 5 }}
              icon={<CustomIcon name='scan-barcode' size={22} style={{ marginRight: 10, color: 'rgba(255,255,255,0.8)' }} />}
              onPress={() => {
                const func = (data) => {
            ...
            <Button
              ...
              primary
            >
              <TextField style={{ textTransform: 'uppercase', textAlign: 'center', width: '100%' }}>{t('continue')}</TextField>
            </Button>
          </View>
        </Card>
      </ScreenLayout>
